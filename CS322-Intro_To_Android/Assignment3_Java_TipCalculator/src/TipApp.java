...
public class TipApp extends TipCalculator{
	...
	/******************************************************
	 * 
	 * main initializes an "app" using the class, creates a 
	 * tipCalculator object, and calculates through the "app"
	 * 
	 ******************************************************/
	...
	/******************************************************
	 * 
	 * calculateTips gets and checks scanner input, 
	 * calls related tipCalculator methods, and prints the results
	 * 
	 ******************************************************/
	public void calculateTips(TipCalculator tip) {
		boolean valid = false;		//boolean to check if input is valid
		boolean bContinue = true; 	//boolean to check for another bill
		double bill = 0;			//local temp bill 
		int percentage = 0;			//local temp percentage
		int partySize = 0;			//local temp partySize
		char cont;					//character for Y/N response
